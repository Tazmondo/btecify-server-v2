...
def test_get_playlists():
    ...
    data = response.json()
    assert repr(
        data) == """[{'id': 1, 'title': 'playlist1', 'songs': [{'id': 1, 'title': 'song1', 'weburl': 'https://www.youtube.com/watch?v=iSqnJPdyqFM', 'disabled': True, 'album': {'id': 1, 'title': 'album2'}, 'duration': 50.3, 'extractor': 'youtube', 'artist': {'id': 1, 'title': 'artist2'}, 'dateadded': '2022-04-23T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-23T02:40:00'}]}, {'id': 3, 'title': 'song2', 'weburl': 'https://www.youtube.com/watch?v=ggHN5ZJ8jkU', 'disabled': False, 'album': {'id': 2, 'title': 'album1'}, 'duration': 22.3, 'extractor': 'bandcamp', 'artist': {'id': 2, 'title': 'artist1'}, 'dateadded': '2022-04-24T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-24T02:40:00'}, {'id': 2, 'title': 'playlist2', 'dateadded': '2022-04-25T02:40:00'}]}, {'id': 2, 'title': 'song4', 'weburl': 'a bad url', 'disabled': False, 'album': {'id': 1, 'title': 'album2'}, 'duration': None, 'extractor': None, 'artist': {'id': 1, 'title': 'artist2'}, 'dateadded': '2022-04-26T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-26T02:40:00'}]}]}, {'id': 2, 'title': 'playlist2', 'songs': [{'id': 4, 'title': 'song3', 'weburl': 'https://www.youtube.com/watch?v=BbbcvFJ55F4', 'disabled': False, 'album': {'id': 2, 'title': 'album1'}, 'duration': 10.3, 'extractor': 'youtube', 'artist': {'id': 2, 'title': 'artist1'}, 'dateadded': '2022-04-26T02:40:00', 'playlists': [{'id': 2, 'title': 'playlist2', 'dateadded': '2022-04-26T02:40:00'}]}, {'id': 3, 'title': 'song2', 'weburl': 'https://www.youtube.com/watch?v=ggHN5ZJ8jkU', 'disabled': False, 'album': {'id': 2, 'title': 'album1'}, 'duration': 22.3, 'extractor': 'bandcamp', 'artist': {'id': 2, 'title': 'artist1'}, 'dateadded': '2022-04-25T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-24T02:40:00'}, {'id': 2, 'title': 'playlist2', 'dateadded': '2022-04-25T02:40:00'}]}]}]"""
...
def test_get_playlist():
    ...
    assert response.status_code == 200
    assert repr(
        response.json()) == """{'id': 1, 'title': 'playlist1', 'songs': [{'id': 1, 'title': 'song1', 'weburl': 'https://www.youtube.com/watch?v=iSqnJPdyqFM', 'disabled': True, 'album': {'id': 1, 'title': 'album2'}, 'duration': 50.3, 'extractor': 'youtube', 'artist': {'id': 1, 'title': 'artist2'}, 'dateadded': '2022-04-23T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-23T02:40:00'}]}, {'id': 3, 'title': 'song2', 'weburl': 'https://www.youtube.com/watch?v=ggHN5ZJ8jkU', 'disabled': False, 'album': {'id': 2, 'title': 'album1'}, 'duration': 22.3, 'extractor': 'bandcamp', 'artist': {'id': 2, 'title': 'artist1'}, 'dateadded': '2022-04-24T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-24T02:40:00'}, {'id': 2, 'title': 'playlist2', 'dateadded': '2022-04-25T02:40:00'}]}, {'id': 2, 'title': 'song4', 'weburl': 'a bad url', 'disabled': False, 'album': {'id': 1, 'title': 'album2'}, 'duration': None, 'extractor': None, 'artist': {'id': 1, 'title': 'artist2'}, 'dateadded': '2022-04-26T02:40:00', 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-26T02:40:00'}]}]}"""
...
def test_get_songs():
    ...
    expected = """[{"id":1,"title":"song1","weburl":"https://www.youtube.com/watch?v=iSqnJPdyqFM","disabled":true,"album":{"id":1,"title":"album2"},"duration":50.3,"extractor":"youtube","artist":{"id":1,"title":"artist2"},"playlists":[{"id":1,"title":"playlist1","dateadded":"2022-04-23T02:40:00"}]},{"id":2,"title":"song4","weburl":"a bad url","disabled":false,"album":{"id":1,"title":"album2"},"duration":null,"extractor":null,"artist":{"id":1,"title":"artist2"},"playlists":[{"id":1,"title":"playlist1","dateadded":"2022-04-26T02:40:00"}]},{"id":3,"title":"song2","weburl":"https://www.youtube.com/watch?v=ggHN5ZJ8jkU","disabled":false,"album":{"id":2,"title":"album1"},"duration":22.3,"extractor":"bandcamp","artist":{"id":2,"title":"artist1"},"playlists":[{"id":1,"title":"playlist1","dateadded":"2022-04-24T02:40:00"},{"id":2,"title":"playlist2","dateadded":"2022-04-25T02:40:00"}]},{"id":4,"title":"song3","weburl":"https://www.youtube.com/watch?v=BbbcvFJ55F4","disabled":false,"album":{"id":2,"title":"album1"},"duration":10.3,"extractor":"youtube","artist":{"id":2,"title":"artist1"},"playlists":[{"id":2,"title":"playlist2","dateadded":"2022-04-26T02:40:00"}]}]"""
    assert (response.status_code == 200)
...
def test_get_song():
    ...
    assert (
            repr(
                response.json()) == """{'id': 1, 'title': 'song1', 'weburl': 'https://www.youtube.com/watch?v=iSqnJPdyqFM', 'disabled': True, 'album': {'id': 1, 'title': 'album2'}, 'duration': 50.3, 'extractor': 'youtube', 'artist': {'id': 1, 'title': 'artist2'}, 'playlists': [{'id': 1, 'title': 'playlist1', 'dateadded': '2022-04-23T02:40:00'}]}"""
    )
